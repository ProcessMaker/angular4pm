...
export class TasksService {
	...
	public getTasksById(
		...
		reportProgress?: boolean,
		options?: { httpHeaderAccept?: 'application/json' }
	): Observable<ProcessRequestToken>;
	public getTasksById(
		taskId: number,
		include?: string,
		observe?: 'response',
		reportProgress?: boolean,
		options?: { httpHeaderAccept?: 'application/json' }
	): Observable<HttpResponse<ProcessRequestToken>>;
	public getTasksById(
		taskId: number,
		include?: string,
		observe?: 'events',
		reportProgress?: boolean,
		options?: { httpHeaderAccept?: 'application/json' }
	): Observable<HttpEvent<ProcessRequestToken>>;
	public getTasksById(
		taskId: number,
		include?: string,
		observe: any = 'body',
		...
		if (taskId === null || taskId === undefined) {
			throw new Error(
				'Required parameter taskId was null or undefined when calling getTasksById.'
			);
		}
		...
		return this.httpClient.get<ProcessRequestToken>(
			`${this.configuration.basePath}/tasks/${encodeURIComponent(
				String(taskId)
			)}`,
			{
				params: queryParameters,
	...
	public updateTask(
		...
		if (inlineObject13 === null || inlineObject13 === undefined) {
			throw new Error(
				'Required parameter inlineObject13 was null or undefined when calling updateTask.'
			);
		}
		...
		return this.httpClient.put<ProcessRequestToken>(
			`${this.configuration.basePath}/tasks/${encodeURIComponent(
				String(taskId)
			)}`,
			inlineObject13,
